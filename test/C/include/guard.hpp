...
public:
    ...
    void reset(scl_dense_t h = nullptr) {
        if (handle_ && handle_ != h) {
            // scl_dense_destroy(handle_);  // TODO: Uncomment when Dense C-API is implemented
        }
        handle_ = h;
    }
...
// Helper Functions
// =============================================================================
// TODO: Rewrite these helper functions to use the new C-API (scl_sparse_from_csr, etc.)
