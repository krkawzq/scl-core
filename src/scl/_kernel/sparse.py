...
def primary_sums_csr(
    ...
    Args:
        ...
        output: Output array pointer [rows] (modified in-place).
    ...
    status = lib.scl_primary_sums_csr(data, indices, indptr, rows, cols, output)
...
def primary_sums_csc(
    ...
    Args:
        ...
        rows: Number of rows.
        cols: Number of columns.
        output: Output array pointer [cols] (modified in-place).
    ...
    status = lib.scl_primary_sums_csc(data, indices, indptr, rows, cols, output)
...
def primary_means_csr(
    ...
    status = lib.scl_primary_means_csr(data, indices, indptr, rows, cols, output)
...
def primary_means_csc(
    ...
    status = lib.scl_primary_means_csc(data, indices, indptr, rows, cols, output)
...
def primary_variances_csr(
    ...
    lib.scl_primary_variances_csr.argtypes = [
        ctypes.c_void_p, ctypes.c_void_p, ctypes.c_void_p,
        c_index, c_index, ctypes.c_int, ctypes.c_void_p
    ]
    lib.scl_primary_variances_csr.restype = ctypes.c_int
    
    status = lib.scl_primary_variances_csr(data, indices, indptr, rows, cols, ddof, output)
...
def primary_variances_csc(
    ...
    status = lib.scl_primary_variances_csc(data, indices, indptr, rows, cols, ddof, output)
...
def primary_nnz_counts_csr(
    ...
    Args:
        indptr: CSR row pointers pointer.
        rows: Number of rows.
        output: Output counts pointer [rows] (modified in-place).
    ...
    lib.scl_primary_nnz_counts_csr.argtypes = [
        ctypes.c_void_p, c_index, ctypes.c_void_p
    ]
...
def primary_nnz_counts_csc(
    ...
    Args:
        indptr: CSC column pointers pointer.
        cols: Number of columns.
        output: Output counts pointer [cols] (modified in-place).
